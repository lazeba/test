  ...
  private void initListeners() {
    ...
    for (Class<? extends ITestNGListener> c : listenerClasses) {
      ...
      if (listener instanceof ISuiteListener) {
        m_suite.addSuiteListener((ISuiteListener) listener);
      }
      if (listener instanceof IInvokedMethodListener) {
        m_suite.addInvokedMethodListener((IInvokedMethodListener) listener);
      }
      ...
      if (listener instanceof IReporter) {
        m_suite.addReporter((IReporter) listener);
      }
